...
using StreetcodeCoordinateEntity = Streetcode.BLL.Entities.AdditionalContent.Coordinates.Types.StreetcodeCoordinate;
namespace Streetcode.BLL.MediatR.AdditionalContent.Coordinate.Update
{
    public class UpdateCoordinateHandler : IRequestHandler<UpdateCoordinateCommand, Result<Unit>>
    {
        ...
        {
            var streetcodeCoordinate = _mapper.Map<StreetcodeCoordinateEntity>(request.StreetcodeCoordinate);
