...
{
    public class DeletePartnerHandlerOld : IRequestHandler<DeletePartnerQuery, Result<PartnerDto>>
    {
        private readonly IMapper _mapper;
        private readonly IRepositoryWrapper _repositoryWrapper;
        private readonly ILoggerService _logger;

        public DeletePartnerHandlerOld(IRepositoryWrapper repositoryWrapper, IMapper mapper, ILoggerService logger)
        {
