...
namespace Streetcode.XUnitTest.MediatRTests.Team
{
    public class GetAllMainTeamHandlerTests
    {
        ...
        [Fact]
        public async Task GetAllMainTeam_ShouldReturnOk_WhenTeamExists()
        {
            // Arrange
            MockRepositorySetupReturnsData();
            MockMapperSetup();

            var handler = new GetAllMainTeamHandler(
        ...
        [Fact]
        public async Task GetAllMainTeam_ShouldReturnCollectionOfCorrectCount_WhenTeamExists()
        {
            // Arrange
        ...
        [Fact]
        public async Task GetAllMainTeam_RepositoryShouldCallGetAllAsyncOnlyOnce_WhenTeamExists()
        {
            // Arrange
            MockRepositorySetupReturnsData();
            MockMapperSetup();
            ...
            // Act
            await handler.Handle(new GetAllMainTeamQuery(), CancellationToken.None);

            // Assert
            _mockRepositoryWrapper.Verify(
                repo =>
                repo.TeamRepository.GetAllAsync(
        ...
        [Fact]
        public async Task GetAllMainTeam_MapperShouldMapOnlyOnce_WhenTeamExists()
        {
            // Arrange
            MockRepositorySetupReturnsData();
            MockMapperSetup();
        ...
        [Fact]
        public async Task GetAllMainTeam_ShouldReturnCollectionOfTeamMemberDto_WhenTeamExists()
        {
            // Arrange
            MockRepositorySetupReturnsData();
            MockMapperSetup();
        ...
        [Fact]
        public async Task GetAllMainTeam_ShouldReturnFail_WhenTeamIsNull()
        {
            // Arrange
        ...
        [Fact]
        public async Task GetAllMainTeam_ShouldLogCorrectErrorMessage_WhenTeamIsNull()
        {
            // Arrange
            MockRepositorySetupReturnsNull();
